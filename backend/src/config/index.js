...
export const config = {
  ...
  tencentCloud: {
    ...
    image2WatermarkResolution: process.env.TENCENTCLOUD_IMAGE2_WATERMARK_RESOLUTION || "2K",
    image2WatermarkPoints: Number(process.env.TENCENTCLOUD_IMAGE2_WATERMARK_POINTS || 25),
    image2EnhancePoints: Number(process.env.TENCENTCLOUD_IMAGE2_ENHANCE_POINTS || 25),
