  ...
  try {
    ...
    await connection.query(`
      ...
      VALUES
        ...
        ('minimax_h3_2k', 'minimax', 'MiniMax-H3', 'MiniMax H3 2K', 'multimodal', 'per_second', 120, 0.530,
    ...
    await connection.query(`
      ...
      SET base_points = CASE
            WHEN model_key IN ('minimax_h3_2k', 'seedance_2_0_720p', 'seedance_2_0_mini', 'kling_3_std') THEN 120
            ELSE base_points
          END,
          enabled = CASE
