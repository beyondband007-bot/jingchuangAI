...
async function createTables() {
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS replicate_tasks (
      ...
      source_thumbnail_url VARCHAR(1000) NULL,
  ...
  const replicateColumnsToAdd = [
    ...
    ["source_thumbnail_url", "VARCHAR(1000) NULL AFTER source_url"]
  ];
  ...
  try {
    ...
    await connection.query(`
      ...
      VALUES
        ...
        ('gpt_image_2', 'Facemini Image2', 35, TRUE),
        ('gpt_image_2_i2i', 'Facemini Image2 图生图', 35, TRUE),
