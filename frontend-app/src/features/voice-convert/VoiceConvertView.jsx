              ...
              recentResults.map((item) => (
                <article className="voice-recent-card" key={item.id}>
                  ...
                  >
                    ...
                    <button className={`voice-recent-icon-button ${item.favorite ? "is-favorite" : ""}`} type="button" onClick={() => toggleRecentFavorite(item.id)} data-tooltip={item.favorite ? "取消收藏" : "收藏"} aria-label={item.favorite ? "取消收藏" : "收藏"}>
